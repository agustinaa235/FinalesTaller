...
Un metodo estatico o de clase es un metedo que es independiende de las instancias de la clase. La ventaja que tienen que s que pueden ser invocados sin siquiera
tener alguna instancia de la clase, gracias al operador ::.
ej:
```C++
      class Foo{
            public:
